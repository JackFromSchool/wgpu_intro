...
impl State {
    ...
    pub fn render(&mut self) -> Result<(), wgpu::SurfaceError> {
        ...
        /*
         * In a block so that _render_pass is dropped immediately dropping the reference to the
         * encoder stored within render pass. If this isn't done there will be an error when we try
         * to call encoder.finish()
         */
        {
